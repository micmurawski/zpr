...
{\em name} & Nazwa gry \\
\hline
{\em nazwa} & gracza który utworzył gre \\
\hline
{\em referencja} & na wskaźnik klienta tcp który utworzył gre \\
\hline
\end{DoxyParams}
...
Funkcja obliczająca nowy stan gry \index{Game\+Engine@{Game\+Engine}!game\+Init@{game\+Init}}
